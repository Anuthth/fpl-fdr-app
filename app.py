...
if ratings_df is not None and fixtures_df is not None:
    ...
    start_gw, end_gw = st.sidebar.slider("Select Gameweek Range:", 4, 38, (4, 14))
    ...
    with tab1:
        ...
        # --- FIX: Set default configuration FIRST, with sorting ENABLED ---
        ...
        # --- FIX: Added the custom comparator for intelligent sorting ---
