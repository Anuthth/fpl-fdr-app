...
if ratings_df is not None and fixtures_df is not None:
    ...
    with tab1:
        ...
        # FIX: Use flex instead of fixed width for responsive columns
        gb.configure_column("Team", pinned='left', cellStyle={'textAlign': 'left'}, flex=2)
        gb.configure_column("Total Difficulty", flex=1)
    ...
    with tab2:
        ...
        gb = GridOptionsBuilder.from_dataframe(df_display)
        gb.configure_column("Team", pinned='left', cellStyle={'textAlign': 'left'}, flex=2)
        gb.configure_column("Total xG", valueFormatter="data['Total xG'].toFixed(2)", flex=1)
    ...
    with tab3:
        ...
        gb = GridOptionsBuilder.from_dataframe(df_display)
        gb.configure_column("Team", pinned='left', cellStyle={'textAlign': 'left'}, flex=2)
        gb.configure_column("xCS", header_name="Expected CS (xCS)", valueFormatter="data['xCS'].toFixed(2)", flex=1)
